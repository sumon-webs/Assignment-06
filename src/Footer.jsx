...
const Footer = () => {
    return (
        <div className=' bg-neutral'>
            <div className=' px-6 lg:px-0 container mx-auto text-[#c5c1c1] py-10 lg:py-20'>
                <div className=' grid lg:grid-cols-7 mx-auto mb-10 pb-6 border-b border-gray-50'>
                    <div className=' mb-6 lg:mb-0 lg:col-span-2 text-center lg:text-start lg:pr-20 space-y-2'>
                    ...
                    <div className=' flex lg:col-span-5 justify-between flex-wrap'>
                        <div className=' space-y-2'>
                            <h3 className=' lg:text-2xl text-white font-semibold'>Product</h3>
                        ...
                        <div className=' space-y-2'>
                            <h3 className=' lg:text-2xl text-white font-semibold'>Company</h3>
                        ...
                        <div className=' space-y-2'>
                            <h3 className=' lg:text-2xl text-white font-semibold'>Resources</h3>
                            <ul>
                                <li>Documentation</li>
                                <li>Help Center</li>
                                <li>Community</li>
                        ...
                        <div className=' lg:col-span-2 space-y-4'>
                            <h3 className=' lg:text-2xl text-white font-semibold'>Social Media</h3>
